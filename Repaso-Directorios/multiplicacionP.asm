...
section .data
	...
	path1 db "/home/karla/PracticaExamen/Ensayo2/arregloM1.txt", 0
	path2 db "/home/karla/PracticaExamen/Ensayo2/arregloM2.txt", 0
	path3 db "/home/karla/PracticaExamen/Ensayo2/resultadoM.txt", 0
